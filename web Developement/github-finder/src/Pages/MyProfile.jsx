...
const MyProfile = () => {
  ...
  useEffect(() => {
    const apiCall = setTimeout(() => {
      axios.get("https://api.github.com/users/Himanshu-dev-web").then((res) => setData(res.data));
      axios.get("https://api.github.com/users/Himanshu-dev-web/repos").then((res) => setRepos(res.data));
    }, 1500);
